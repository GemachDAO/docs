...
Toggle the "Quick Buy" option to show only tokens that are available for immediate purchase through GDEX.pro.

#### Amount Presets

Select from preset amounts (0.5, 1, 5) to quickly set your preferred purchase amount when using the Quick Buy feature.
...
This section displays tokens that have been recently created or listed. These are often the newest opportunities in the market but may come with higher risk.

#### About to Graduate

This section shows tokens that have met certain criteria and are about to "graduate" to a more established status. These may represent tokens that have proven some initial stability or growth.
...
* **Token Symbol**: The abbreviated code representing the token
* **Token Name**: The full name of the token
* **Token Icon**: Visual representation of the token

#### Token Metrics

* **Time Since Creation**: How long the token has been available
* **Price Information**: Current price and price change indicators
* **Market Metrics**: Information about market cap, liquidity, and volume
* **Quick Buy Buttons**: Options to quickly purchase the token in preset amounts
