...
| **Agent Skills** | Modular skill packages that extend Gclaw and Gemach AI with new on-chain capabilities | [Docs](products/agent-skills/README.md) |
...
1. **[Getting Started Guide](getting-started/README.md)** — crypto basics, wallets, and DeFi explained for beginners
2. **[GDex Pro](products/gdex-pro/README.md)** — open [gdex.pro](https://gdex.pro), sign in with Google via Web3Auth, and make your first trade in under two minutes
3. **[Gemach AI](products/gemach-ai/README.md)** — describe what you want to do in plain language and let the AI handle the execution
